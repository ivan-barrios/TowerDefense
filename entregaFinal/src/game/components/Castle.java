...
public class Castle {
	...
	// activeMoster se fija si ambos caminos estan vacios(true) o no (false)
	public boolean activeMonster(Player player) {
		return (!this.westPath.haveMonster(player.getId()) && !this.eastPath.haveMonster(player.getId()));
	}
}
